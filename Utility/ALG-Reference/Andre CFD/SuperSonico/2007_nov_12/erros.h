...
#include <iostream>
    ...
    #define IMPRIMIR_ERRO_FRONTEIRA_ID_VARIAVEL_INEXISTENTE() ({cout << "Erro: uma condicao de fronteira foi solicitada para uma id de variavel inexistente!" << endl; pausar(1);})
    ...
    #define IMPRIMIR_ERRO_FACE_INVALIDA_DUDY() ({cout << "Erro: foi solicitado calculo de du/dy em uma face invalida!" << endl; pausar(1);})

    #define IMPRIMIR_ERRO_FACE_INVALIDA_DVDX() ({cout << "Erro: foi solicitado calculo de dv/dx em uma face invalida!" << endl; pausar(1);})

    #define IMPRIMIR_ERRO_FACE_INVALIDA_DVDY() ({cout << "Erro: foi solicitado calculo de dv/dy em uma face invalida!" << endl; pausar(1);})

    #define IMPRIMIR_ERRO_FACE_INVALIDA_DTDX() ({cout << "Erro: foi solicitado calculo de dT/dx em uma face invalida!" << endl; pausar(1);})

    #define IMPRIMIR_ERRO_FACE_INVALIDA_DTDY() ({cout << "Erro: foi solicitado calculo de dT/dy em uma face invalida!" << endl; pausar(1);})

    #define IMPRIMIR_ERRO_DUDX_FORA() ({cout << "Erro: foi solicitado o calculo de du/dx fora do dominio, ou seja, em algum vol. ficticio!" << endl; pausar(1);})

    #define IMPRIMIR_ERRO_DUDY_FORA() ({cout << "Erro: foi solicitado o calculo de du/dy fora do dominio, ou seja, em algum vol. ficticio!" << endl; pausar(1);})

    #define IMPRIMIR_ERRO_DVDX_FORA() ({cout << "Erro: foi solicitado o calculo de dv/dx fora do dominio, ou seja, em algum vol. ficticio!" << endl; pausar(1);})

    #define IMPRIMIR_ERRO_DVDY_FORA() ({cout << "Erro: foi solicitado o calculo de dv/dy fora do dominio, ou seja, em algum vol. ficticio!" << endl; pausar(1);})

    #define IMPRIMIR_ERRO_DTDX_FORA() ({cout << "Erro: foi solicitado o calculo de dT/dx fora do dominio, ou seja, em algum vol. ficticio!" << endl; pausar(1);})

    #define IMPRIMIR_ERRO_DTDY_FORA() ({cout << "Erro: foi solicitado o calculo de dT/dy fora do dominio, ou seja, em algum vol. ficticio!" << endl; pausar(1);})
    ...
    #define IMPRIMIR_ERRO_VAR_NAO_IMPLEMENTADA() ({cout << "Erro: essa variavel ainda nao foi implementada na funcao obtemVariaveisVizinhas()" << endl; pausar(1);}) 
