...
#define CONSTANTS_H
    ...
    #define LEGENDA_LIM_SUP_DENSIDADE           1.5 * PRESSAO_LIVRE / (R*TEMPERATURA_LIVRE)
    #define LEGENDA_LIM_INF_DENSIDADE           0.0
    #define LEGENDA_LIM_SUP_TEMPERATURA         520.0
    #define LEGENDA_LIM_INF_TEMPERATURA         250.0
    #define LEGENDA_LIM_SUP_PRESSAO             1.5 * PRESSAO_LIVRE
    #define LEGENDA_LIM_INF_PRESSAO             0.9 * PRESSAO_LIVRE
    // Cores dos graficos
