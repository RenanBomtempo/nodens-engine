...
//Variables used in solving the Navier-Stokes equations.
    ...
    bool volumeFicticio; // Indica se a celula e' fantasma ou nao
    short direcaoFronteira; // Define a direcao da fronteira nesta celula, se for o caso de volume ficticio
