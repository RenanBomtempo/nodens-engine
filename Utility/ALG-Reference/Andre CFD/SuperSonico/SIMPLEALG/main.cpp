 ...
 *              Titulo: Método SIMPLE para o escoamento supersonico
 *              numa placa plana
 *
 * Ultima atualizacao: 09/05/07 22:00
 * ======================================================================= */
// main.cpp
...
double escalaZoomVisualizacao = 1.1/LHORI;
...
void myDisplay(void)
{
    ...
    { 
		...
		/*if(malhaESSPP->tempoAtual >= 0.00000045)
		{
			pausaSimulacao = true;
			verificaResultado( malhaESSPP );
		}*/
    }
    ...
    switch( visualizarQualGrafico )
    {
        ...
        case 3:
            desenharVelocidade( malhaESSPP, VEL_LIVRE );   
        break;
...
{  
    ...
    // Titulo na tela
    cout << "=======================================\n";
    cout << "ESCOAMENTO SUPERSONICO NA PLACA PLANA\n\n";
    cout << "-------- data: 17/05/07\n";
    cout << " PEG FLUIDOS \n";
    cout << "=======================================\n\n"; 
    ...
    glutCreateWindow("Escoamento Supersonico com SIMPLEC");
    //glutFullScreen();
