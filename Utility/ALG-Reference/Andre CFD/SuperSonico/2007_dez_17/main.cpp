...
/* TAREFAS:
- Fazer e melhorar o derefinement.cpp

- Tem que entender porque a funcao de refinar esta refinando sem parar.
- Tem que ver sobre o refinamento dos ficticios.
*/
...
int visualizarQualGrafico = ID_GRAFICO_TEMP;
...
void aplicarOpcoesMenu(){
    switch (opcaoEscolhidaMenu){
        ...
        case 15: //mach Velocidade
            visualizarQualGrafico = ID_GRAFICO_MACH;
            visualizarResiduo = false;
            opcaoEscolhidaMenu = -1; 
        break;            
...
/*
-----------------------------------------------------------------------
   MEU DISPLAY: onde sera pintado e executado funcoes principais
-----------------------------------------------------------------------
*/
void *resolveProblema(void *)
{
    ...
    {
        /* Procede os calculos */
        if( !pausaSimulacao ) // Aqui entram as funcoes para resolver os Navier-Stokes
        {

                // Resolve por SIMPLEC
                solveSuperSonicSIMPLEC( malhaESSPP );

                refineGrid( malhaESSPP, REFINAMENTO_MAX, COTA_REFINAMENTO );
                derefineGrid( malhaESSPP, COTA_DESREFINAMENTO, false );
                ...
                //atualizaPassoTempo( malhaESSPP, iteracoesTempo );
...
void myDisplay()
{
    ...
    desenharTempo( malhaESSPP->tempoAtual, escalaZoomVisualizacao,
                   translacaoHorizontalVisualizacao,
                   translacaoVerticalVisualizacao );
    /**/
    ...
    switch( visualizarQualGrafico )
    {
        ...
        case ID_GRAFICO_MACH:
            desenharMach( malhaESSPP );
        break;
