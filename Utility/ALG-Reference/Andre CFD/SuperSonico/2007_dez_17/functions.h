...
______________________________________________________________________________*/
    ...
    double interpolaUsandoPlano( double, double, double, double, double, double,
...
______________________________________________________________________________*/
    ...
    void desenharMach( Grid * );
    void desenharTempo( double, double, double, double );
...
______________________________________________________________________________*/
    ...
    double calculaVarVizinho( Cell *, short, int & );
    void insereCoeficientesVizinho( Cell *, Cell *, double, short );
    ...
    int atualizaPassoTempo( Grid *, int );
...
______________________________________________________________________________*/
    ...
    int calculaCoeficientesMomento( Grid * );
    int calculaTermoFonteMomento( Grid * );
...
______________________________________________________________________________*/
    ...
    bool verificaVizFicticio( Cell *, int & );
