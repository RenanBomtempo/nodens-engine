...
void derefineBunch( Cell *cell, bool drawGrid )
{
    ...
    NOVOeAtual = 
        (   firstCell->eAtual + secondCell->eAtual 
          + thirdCell->eAtual + fourthCell->eAtual 
        ) /4;
    NOVOeAnterior = 
        (   firstCell->eAnterior + secondCell->eAnterior 
          + thirdCell->eAnterior + fourthCell->eAnterior 
        ) /4;
    NOVOeIterAnterior = 
        (   firstCell->eIterAnterior + secondCell->eIterAnterior 
          + thirdCell->eIterAnterior + fourthCell->eIterAnterior 
        ) /4;
    NOVOTAtual = 
    ...
    newCell->eAtual = NOVOeAtual;
    newCell->eAnterior = NOVOeAnterior;
    newCell->eIterAnterior = NOVOeIterAnterior;
