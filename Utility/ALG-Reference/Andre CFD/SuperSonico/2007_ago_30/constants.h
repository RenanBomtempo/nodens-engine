...
#define CONSTANTS_H
    ...
    #define VEL_LIVRE               3.0 * VEL_SOM  //         m / s
    ...
    // Cotas
    #define COTA_PRESSAO                        0.005
    #define COTA_VELOCIDADES                    0.005
    #define COTA_TEMPERATURA                    0.005
    #define COTA_GRADCONJUGADO                  1e-9
    #define LIMITE_ITERACOES_GRADBICONJUGADO    8000
    #define RELAXAMENTO_P                       0.01
    #define RELAXAMENTO_U                       0.01
    #define RELAXAMENTO_V                       0.01
    #define RELAXAMENTO_T                       0.01
    #define MAXITER_A                           100 //40
    #define MAXITER_B                           10 //5
    #define MAXITER_C                           10 //6
    ...
    #define LIMITE_INFERIOR_RESIDUO             1e-12
    #define LEGENDA_LIM_SUP_DENSIDADE           2.2 * PRESSAO_LIVRE / (R*TEMPERATURA_LIVRE)
    #define LEGENDA_LIM_INF_DENSIDADE           0.0
    #define LEGENDA_LIM_SUP_TEMPERATURA         750.0
    #define LEGENDA_LIM_INF_TEMPERATURA         153.75
    #define LEGENDA_LIM_SUP_PRESSAO             3.0 * PRESSAO_LIVRE
    #define LEGENDA_LIM_INF_PRESSAO             0.0
    // Cores dos graficos
    #define COR_LIM_SUP_DENSIDADE               (1.0, 0.0, 0.0)  // vermelho
    #define COR_LIM_INF_DENSIDADE               (0.0, 0.65, 0.0) // verde
    #define COR_LIM_SUP_TEMPERATURA             (1.0, 0.0, 0.75) // rosa
    #define COR_LIM_INF_TEMPERATURA             (0.0, 0.65, 0.0) // verde
    #define COR_LIM_SUP_PRESSAO                 (1.0, 0.0, 0.0)  // vermelho
    #define COR_LIM_INF_PRESSAO                 (0.0, 0.0, 1.0)  // azul
