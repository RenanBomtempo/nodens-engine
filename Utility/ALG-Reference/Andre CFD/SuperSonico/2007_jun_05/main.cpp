...
void aplicarOpcoesMenu(){
    switch (opcaoEscolhidaMenu){
        ...
        case 21:
            ...
            if(visualizarCelulasMalha == true) 
                visualizarResiduo = false;
            opcaoEscolhidaMenu = -1;
        break;
        ...
        case 25:
            ...
            visualizarCelulasMalha = visualizarLegenda 
                                   = visualizarCarnaval 
                                   = visualizarEnfeites 
                                   = visualizarPeano
                                   = false;
...
void createMenu(void){
    ...
    glutAddMenuEntry("Resultado num�rico \"Carnaval\"",23);
    glutAddMenuEntry("Legenda", 24);
    glutAddMenuEntry("Gr�fico de res�duos", 25);
