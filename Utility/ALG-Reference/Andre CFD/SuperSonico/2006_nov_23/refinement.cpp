...
void refineCell( Cell *cell, bool drawGrid )
{
    ...
    if( drawGrid )
    {
        ...
        //and next cells.
   	    ...
   	    setColor(5);
   	    drawLine( cellCenterX - cellHalfSide, cellCenterY,0,
   	    		  cellCenterX + cellHalfSide, cellCenterY,0 );
	    drawLine( cellCenterX, cellCenterY - cellHalfSide,0,
 			      cellCenterX, cellCenterY + cellHalfSide,0 );
     }
    ...
    */
    ...
    northwestSubCell->eAtual = northeastSubCell->eAtual;
    northwestSubCell->eAnterior = northeastSubCell->eAnterior;
    northwestSubCell->eIterAnterior = northeastSubCell->eIterAnterior;
    ...
    southwestSubCell->eAtual = northeastSubCell->eAtual;
    southwestSubCell->eAnterior = northeastSubCell->eAnterior;
    southwestSubCell->eIterAnterior = northeastSubCell->eIterAnterior;
    ...
    southeastSubCell->eAtual = northeastSubCell->eAtual;
    southeastSubCell->eAnterior = northeastSubCell->eAnterior;
    southeastSubCell->eIterAnterior = northeastSubCell->eIterAnterior;
