...
/*______________________________________________________________________________
    ...
    Insere um elemento de lista encadeada (relativo a 
escolheElementEquacao) apos o primeiro elemento dessa lista.
