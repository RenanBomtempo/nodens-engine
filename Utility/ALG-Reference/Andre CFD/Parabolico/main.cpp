 ...
 *              Titulo: Metodo SIMPLEC para o escoamento incompressivel
 *                          entre duas placas planas.
 *
 * Ultima atualizacao: 29/05/07 22:00
 * ======================================================================= */
// main.cpp
...
- Condicao de fronteira (valorCondicaoFronteira) da
E_t para norte e sul (fronteira prescrita).

- Corrigido os coeficientes de p' no leste e oeste. => valor u dos ficticios 
na saida ficou melhor! Chega em exatamente 1.5, mas infelizmente ultrapassa 1.5

- CalculaCoeficientesEnergia esta' modularizado para
receber diferentes tipos de fronteira.
...
/*-----------------------------------------------------------------------------*
* Funcaoo chamada para gerenciar eventos com teclas especiais do teclado, tais *
* como UP E DOWN.                                                             *
*----------------------------------------------------------------------------*/
...
{  
    ...
    // Titulo na tela
    cout << "=======================================\n";
    cout << "ESCOAMENTO INCOMPRESSIVEL PARABOLICO \n\n";
    cout << "-------- data: 05/06/07\n";
    cout << " PEG FLUIDOS \n";
    cout << "=======================================\n\n"; 
    ...
    glutCreateWindow("Escoamento parabolico por SIMPLEC");
    //glutFullScreen();
