    ...
    else 
    {
        ...
        {             // ---------------------------------------------------------
            ...
            case 'w': // -------------- FACE OESTE -------------------------------
                ...
                else        // dudx na fronteira oeste
                    return (celula->uAtual - celula->westFaceU) * 2.0 / celula->faceLength;
...
/*______________________________________________________________________________
         ...
         Calcula gradiente de temperatura horizontal em uma face solicitada.

    Parametros:
        celula: celula principal (central) do calculo.
        face: em qual face a derivada sera' calculada.

Criado por Andre STALTZ dia 14/05/07
______________________________________________________________________________*/
double dTdx( Cell *celula, char face )
{
    double TLeste = 0.0,
           TOeste = 0.0;
    ...
    else
    {
        ...
        {             // ---------------------------------------------------------
            ...
            default: // Outras faces
                IMPRIMIR_ERRO_FACE_INVALIDA_DTDX();
                return 0.0;
            break;

            cout << "Na funcao dTdx() [1]:" << endl;
            IMPRIMIR_ERRO_FLUXO_EXECUCAO();
            return ERRO_FLUXO_EXECUCAO;
        }
    }

    cout << "Na funcao dTdx() [2]:" << endl;
    IMPRIMIR_ERRO_FLUXO_EXECUCAO();
    return ERRO_FLUXO_EXECUCAO;
}
...
/*______________________________________________________________________________
         ...
         Calcula gradiente de temperatura vertical em uma face solicitada.
...
Criado por Andre STALTZ dia 14/05/07
______________________________________________________________________________*/
double dTdy( Cell *celula, char face )
{
    double TNorte = 0.0,
           TSul = 0.0;
    ...
    else
    {
        ...
        {             // ---------------------------------------------------------
            ...
            default: // Outras faces
                IMPRIMIR_ERRO_FACE_INVALIDA_DTDY();
                return 0.0;
            break;

            cout << "Na funcao dTdy():" << endl;
            IMPRIMIR_ERRO_FLUXO_EXECUCAO();
            return ERRO_FLUXO_EXECUCAO;
        }
    }
