                          ...
                          char direcao )
{
    ...
    switch( direcao )
    {
        case 'n': // Norte -------------------------------------
            ...
            //if( celula->north->volumeFicticio == false )
            //{
                switch( id_variavel )
                {
                    case ID_VAR_RHO: // ===================== RHO =========================
           ...
           //}
            //else
            //    return condicaoFronteira( celula, id_variavel, direcao );
        break;

        case 's': // Sul -------------------------------------
            Gamma = celula->southFaceGamma;

            //if( celula->south->volumeFicticio == false )
            //{
                switch( id_variavel )
                {
                    case ID_VAR_RHO: // ===================== RHO =========================
        ...
        case 'e': // Leste -------------------------------------
            ...
            //if( celula->east->volumeFicticio == false )
            //{
                switch( id_variavel )
                {
                    case ID_VAR_RHO: // ===================== RHO =========================
        ...
        case 'w': // Oeste -------------------------------------
            ...
            //if( celula->west->volumeFicticio == false )
            //{
                switch( id_variavel )
                {
                    case ID_VAR_RHO: // ===================== RHO =========================
