            ...
            switch( direcao )
            {
                case 'n': // Viscosidade no norte -------------------------------
                     if( celula->north->type == 'b' )
                        ...
                        return celula->miAtual; // SOMENTE PARA COUETTE!
                break;
...
______________________________________________________________________________*/
void interpolaTodasInterfaces( Grid *malha, bool primeiraIteracao )
{
    Cell *celula;  
    ...
    if(malha->firstGridCell != NULL)
    {
        ...
        {         
            ...
            //celula->northFaceEt = 0.0;
            //celula->southFaceEt = 0.0;
            //celula->eastFaceEt  = 0.0;
            //celula->westFaceEt  = 0.0;

            //celula->northFaceT = 0.0;
            //celula->southFaceT = 0.0;
            //celula->eastFaceT  = 0.0;
            //celula->westFaceT  = 0.0;

            //celula->northFaceP = 0.0;
            //celula->southFaceP = 0.0;
            //celula->eastFaceP  = 0.0;
            //celula->westFaceP  = 0.0;

            //celula->northFaceMi = 0.0;
            //celula->southFaceMi = 0.0;
            //celula->eastFaceMi  = 0.0;
            //celula->westFaceMi  = 0.0;
    
            //celula->northFaceK = 0.0;
            //celula->southFaceK = 0.0;
            //celula->eastFaceK  = 0.0;
            //celula->westFaceK  = 0.0;
