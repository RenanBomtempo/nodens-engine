...
double escalaZoomVisualizacao = 1.2/LHORI;
...
void myDisplay(void)
{
    ...
    switch( visualizarQualGrafico )
    {
        ...
        case 3:
            desenharVelocidade( malhaESSPP, VEL_PAREDE );   
        break;
...
{  
    ...
    glutCreateWindow("Escoamento de Couette com SIMPLEC");
    //glutFullScreen();
