    ...
    while( continueRefining )
    {
        ...
        while( gridCell != 0 )
        {
            ...
            maximumFaceDifference = fabs(
                             gridCell->pIterCAnterior - gridCell->eastFaceP 
                         );
            // Testa se a face norte e' maior
            if ( fabs( gridCell->pIterCAnterior - gridCell->northFaceP ) 
                 > maximumFaceDifference )
            { 
                maximumFaceDifference = fabs( 
                             gridCell->pIterCAnterior - gridCell->northFaceP
                         );
            }
            // Testa se a face oeste e' maior
            if ( fabs( gridCell->pIterCAnterior - gridCell->westFaceP ) 
                 > maximumFaceDifference )
            {     
                maximumFaceDifference = fabs( 
                            gridCell->pIterCAnterior - gridCell->westFaceP 
                        );
            }
            // Testa se a face sul e' maior
            if ( fabs( gridCell->pIterCAnterior - gridCell->southFaceP ) 
                 > maximumFaceDifference )
            {
                 maximumFaceDifference = fabs(
                             gridCell->pIterCAnterior - gridCell->southFaceP 
                        );            
            }
...
void refineCell( Cell *cell )
{
    ...
    */
    ...
    northwestSubCell->EtAtual = northeastSubCell->EtAtual;
    northwestSubCell->EtAnterior = northeastSubCell->EtAnterior;
    northwestSubCell->EtIterAnterior = northeastSubCell->EtIterAnterior;
    ...
    southwestSubCell->EtAtual = northeastSubCell->EtAtual;
    southwestSubCell->EtAnterior = northeastSubCell->EtAnterior;
    southwestSubCell->EtIterAnterior = northeastSubCell->EtIterAnterior;
    ...
    southeastSubCell->EtAtual = northeastSubCell->EtAtual;
    southeastSubCell->EtAnterior = northeastSubCell->EtAnterior;
    southeastSubCell->EtIterAnterior = northeastSubCell->EtIterAnterior;
